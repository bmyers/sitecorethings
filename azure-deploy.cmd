...
cd bin
:install
curl -o hugo0241.zip -L https://github.com/gohugoio/hugo/releases/download/v0.24.1/hugo_0.24.1_Windows-64bit.zip
echo Installing Hugo...
SetLocal DisableDelayedExpansion & d:\7zip\7za x hugo0241.zip
